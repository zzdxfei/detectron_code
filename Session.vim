...
silent only
cd ~/Desktop/rcnn/Detectron
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +15 configs/12_2017_baselines/e2e_faster_rcnn_R-50-C4_1x.yaml
badd +52 detectron/core/rpn_generator.py
badd +62 detectron/modeling/name_compat.py
badd +1 detectron/modeling/detector.py
badd +20 detectron/modeling/model_builder.py
badd +18 ~/.vim/vimrc
badd +13 detectron/datasets/json_dataset.py
badd +1 detectron/roi_data/fast_rcnn.py
badd +4 detectron/roi_data/loader.py
badd +396 detectron/core/test_engine.py
badd +166 detectron/core/test_retinanet.py
badd +21 projects/GN/README.md
badd +5 NOTICE
badd +3 tools/reval.py
badd +35 tools/train_net.py
badd +1065 ~/Desktop/rcnn/Detectron/detectron/core/config.py
argglobal
silent! argdel *
edit ~/Desktop/rcnn/Detectron/detectron/core/config.py
...
setlocal modeline
setlocal modifiable
setlocal nrformats=bin,octal,hex,alpha
set number
setlocal number
...
let s:l = 156 - ((25 * winheight(0) + 27) / 54)
